...
par(mfrow = c(2,2))
# construct the graphs in order
#plot1
plot(sub_hhp$Time,as.numeric(as.character(sub_hhp$Global_active_power)),type="l",xlab="",ylab="Global Active Power (kilowatts)")
#plot2
plot(sub_hhp$Time,as.numeric(as.character(sub_hhp$Voltage)), type="l",xlab="datetime",ylab="Voltage")
#plot3
...
#plot4
plot(sub_hhp$Time,as.numeric(as.character(sub_hhp$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
